...
if __name__ == "__main__":
    ...
    model_restoration = Uformer(img_size=input_size, in_chans=in_chans, dd_in=dd_in,
                                embed_dim=32,win_size=8,token_projection='linear',token_mlp='leff',modulator=True)
    # model_restoration = Uformer(img_size=input_size, in_chans=in_chans, dd_in=dd_in,
    ...
    from ptflops import get_model_complexity_info
    inp_shape=(1,256,256)
    macs, params = get_model_complexity_info(model_restoration, inp_shape, verbose=False, print_per_layer_stat=False)
