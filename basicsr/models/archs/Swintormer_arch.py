...
class OverlapPatchEmbed(nn.Module):
    def __init__(self, in_c=3, embed_dim=48, bias=False):
        ...
        self.in_c = in_c
        self.proj2 = nn.Conv2d(4, embed_dim, kernel_size=3, stride=1, padding=1, bias=bias)
...
class Swintormer(nn.Module):
    def __init__(self,
        ...
        self.output = nn.Sequential(*[nn.Conv2d(int(dim * 2 ** 1), 4, kernel_size=3, stride=1, padding=1, bias=False),
                                      nn.PixelShuffle(2)])
