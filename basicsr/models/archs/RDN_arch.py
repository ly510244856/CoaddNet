...
# Modified to match pretrained models from https://github.com/yjn870/RDN-pytorch & https://github.com/Coloquinte/torchSR/blob/main/torchsr/models/rdn.py
...
class RDN(nn.Module):
    def __init__(self, scale, G0=64, D=16, C=8, G=64,
                 pretrained=False, map_location=None):
